...
export const getDefaultSettings = () => ({
    ...
    bannerActive: true,
    shippingRates: [
        { country: 'Australia', rate: 0, freeThreshold: 0 },
        { country: 'Austria', rate: 0, freeThreshold: 0 },
        { country: 'Germany', rate: 0, freeThreshold: 0 },
        { country: 'France', rate: 0, freeThreshold: 0 },
        { country: 'United Kingdom', rate: 0, freeThreshold: 0 },
        { country: 'Italy', rate: 0, freeThreshold: 0 },
        { country: 'Netherlands', rate: 15.00, freeThreshold: 0 },
        { country: 'Belgium', rate: 15.00, freeThreshold: 0 },
        { country: 'Spain', rate: 15.00, freeThreshold: 0 },
        { country: 'Poland', rate: 15.00, freeThreshold: 0 },
        { country: 'Sweden', rate: 15.00, freeThreshold: 0 },
        { country: 'Denmark', rate: 15.00, freeThreshold: 0 },
        { country: 'United States', rate: 20.00, freeThreshold: 0 },
        { country: 'Canada', rate: 25.00, freeThreshold: 0 },
    ],
